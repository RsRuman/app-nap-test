            ...
            <section
                ...
                <picture class="relative flex items-center bg-orange sm:bg-transparent">
                    ...
                    <img v-if="selectedImage !== ''" :src="selectedImage"
                         alt="sneaker"
                         class="block sm:rounded-xl xl:w-[70%] xl:rounded-xl m-auto pointer-events-none transition duration-300 lg:w-3/4 h-auto max-h-[750px] lg:pointer-events-auto lg:cursor-pointer lg:hover:shadow-xl"
                         id="hero">
                    <button
                ...
                <div
                    ...
                    <div v-for="(image, iIdx) in productDetail.images" :key="'image'+iIdx" :id="iIdx"
                        ...
                        <img
                            ...
                            :src="image.imagePath"
                             alt="thumbnail" class="rounded-xl hover:opacity-50 transition active" :id="'thumb-'+iIdx"/>
                    </div>
                </div>
            </section>
